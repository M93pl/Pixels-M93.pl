...
public partial class CharacterBody2dEnemy3 : CharacterBody2D
{
    private float speed = 80;
    private CharacterBody2dPlayer3 playerBody;
    ...
    {
        base._Ready();
        playerBody = GetNode<CharacterBody2dPlayer3>("../CharacterBody2D_player");
