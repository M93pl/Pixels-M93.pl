...
{
    private CharacterBody2dEnemy2 enemy;
    private CharacterBody2dPlayer2 player;
    ...
    public override void _Ready()
    {
        ...
        enemy = GetNode<CharacterBody2dEnemy2>("CharacterBody2D_enemy");
        player = GetNode<CharacterBody2dPlayer2>("CharacterBody2D_player");
    ...
    public override void _PhysicsProcess(double delta)
    {
        ...
        if (collider == "CharacterBody2D_enemy")
        {
            ...
            {
                LevelData.Data.levelJustCompleted = "2";
