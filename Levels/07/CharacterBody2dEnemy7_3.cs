...
public partial class CharacterBody2dEnemy7_3 : CharacterBody2D
{
    private float speed = 55;
    private CharacterBody2dPlayer7 playerBody;
    ...
    {
        base._Ready();
        playerBody = GetNode<CharacterBody2dPlayer7>("../CharacterBody2D_player");
