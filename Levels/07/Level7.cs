...
public partial class Level7 : Node2D
{
    private CharacterBody2dEnemy7 enemy;
    private CharacterBody2dPlayer7 player;
    ...
    public override void _Ready()
    {
        ...
        enemy = GetNode<CharacterBody2dEnemy7>("CharacterBody2D_enemy");
        player = GetNode<CharacterBody2dPlayer7>("CharacterBody2D_player");
    ...
    public override void _PhysicsProcess(double delta)
    {
        ...
        if (collider == "CharacterBody2D_enemy" || collider == "CharacterBody2D_enemy2" || collider == "CharacterBody2D_enemy3"
            ...
            || colliderEvent == "CharacterBody2D_enemy4" || colliderEvent == "CharacterBody2D_enemy5" || colliderEvent == "CharacterBody2D_enemy6")
        {
            if (LevelData.Data.HP != 1)
            {
                LevelData.Data.levelJustCompleted = "7";
