...
{
    private CharacterBody2dEnemy8 enemy;
    private CharacterBody2dPlayer8 player;
    ...
    public override void _Ready()
    {
        ...
        enemy = GetNode<CharacterBody2dEnemy8>("CharacterBody2D_enemy");
        player = GetNode<CharacterBody2dPlayer8>("CharacterBody2D_player");
    ...
    public override void _PhysicsProcess(double delta)
    {
            ...
            || colliderEvent == "CharacterBody2D_enemy4" || colliderEvent == "CharacterBody2D_enemy5" || colliderEvent == "CharacterBody2D_enemy6")
        {
            ...
            {
                LevelData.Data.levelJustCompleted = "8";
