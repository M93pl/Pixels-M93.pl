...
public partial class CharacterBody2dEnemy4_2 : CharacterBody2D
{
    private float speed = 75;
    private CharacterBody2dPlayer4 playerBody;
    ...
    {
        base._Ready();
        playerBody = GetNode<CharacterBody2dPlayer4>("../CharacterBody2D_player");
