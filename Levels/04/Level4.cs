...
{
    private CharacterBody2dEnemy4 enemy;
    private CharacterBody2dPlayer4 player;
    ...
    public override void _Ready()
    {
        ...
        enemy = GetNode<CharacterBody2dEnemy4>("CharacterBody2D_enemy");
        player = GetNode<CharacterBody2dPlayer4>("CharacterBody2D_player");
    ...
    public override void _PhysicsProcess(double delta)
    {
        ...
        if (collider == "CharacterBody2D_enemy" || collider == "CharacterBody2D_enemy2" || collider == "CharacterBody2D_enemy3"
            || collider == "CharacterBody2D_enemy4" || collider == "CharacterBody2D_enemy5")
        {
            if (LevelData.Data.HP != 1)
            {
                LevelData.Data.levelJustCompleted = "4";
