...
{
    private CharacterBody2dEnemy5 enemy;
    private CharacterBody2dPlayer5 player;
    ...
    public override void _Ready()
    {
        ...
        enemy = GetNode<CharacterBody2dEnemy5>("CharacterBody2D_enemy");
        player = GetNode<CharacterBody2dPlayer5>("CharacterBody2D_player");
    ...
    public override void _PhysicsProcess(double delta)
    {
            ...
            || collider == "CharacterBody2D_enemy4" || collider == "CharacterBody2D_enemy5" || collider == "CharacterBody2D_enemy6")
        {
            ...
            {
                LevelData.Data.levelJustCompleted = "5";
